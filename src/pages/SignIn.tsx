      ...
      <div className="max-w-md w-full space-y-8 bg-[#111111] p-8 rounded-2xl border border-white/10">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Or{" "}
            <Link to="/signup" className="font-medium text-[#D4A017] hover:text-[#D4A017]/80">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignIn}>
          ...
          {message && (
            <div className="bg-green-500/10 border border-green-500/50 text-green-500 text-sm rounded-md p-3">
              {message}
            </div>
          )}
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <button
                  ...
                  className="text-sm font-medium text-[#D4A017] hover:text-[#D4A017]/80"
                >
                  Forgot password?
                </button>
              </div>
